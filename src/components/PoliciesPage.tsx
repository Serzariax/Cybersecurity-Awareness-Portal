      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="all" className="mb-12">
          <TabsList className="bg-white border border-slate-200">
            ...
            <TabsTrigger value="guides" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
              Guides
            </TabsTrigger>
            <TabsTrigger value="infographics" className="data-[state=active]:bg-teal-600 data-[state=active]:text-white">
              Infographics
            </TabsTrigger>
